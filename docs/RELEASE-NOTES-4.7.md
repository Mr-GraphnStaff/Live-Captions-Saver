# Better CaptionKeep 4.7

Better CaptionKeep 4.7 is the enterprise-ready release: stronger Teams PWA recovery, a polished themed transcript experience, review-first AI handoff, and Scrubby privacy controls.

## Highlights

- Supports both official Teams web hosts and preserves active captions through temporary source loss.
- Restores a recent same-page capture checkpoint after reload and clearly warns about a possible gap.
- Adds CaptionKeep, Light, Midnight, and Follow system themes across extension pages.
- Redesigns the viewer for search, speaker scanning, history, copy, and export.
